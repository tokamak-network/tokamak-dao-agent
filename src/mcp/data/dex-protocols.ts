...
/**
 * CoW Protocol (CoW Swap) - Batch auction settlement
 * GPv2Settlement calls transferFrom on tokens during settlement.
 */
export const COW_SWAP: DexProtocol = {
  name: "CoW Swap (CoW Protocol)",
  routerAddress: "0x9008D19f58AAbD9eD0D60971565AA8510560ab41", // GPv2Settlement
  version: "v2", // Uses transferFrom like V2 routers
  swapAbi: UNISWAP_V2.swapAbi, // Not used directly — transferFrom test is what matters
};
